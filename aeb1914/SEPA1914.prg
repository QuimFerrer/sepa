/* v.1.0 03/12/2013
 * AEB 19.14 Adeudos Directos Versión 2.0 RB SEPA Direct Debit Core
...
static function GenFile(nHandle)
	...
	deut_Adeudo 	:= 'RCUR'									// OOFF Unico pago RCUR Adeudo de varios que no es FNAL ni FRST
